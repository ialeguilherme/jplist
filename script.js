document.addEventListener('DOMContentLoaded', () => {
    ...
    const SUPABASE_URL = 'SUA_URL_DO_PROJETO'; // Substitua pela sua URL do Supabase
    const SUPABASE_ANON_KEY = 'SUA_CHAVE_ANON_PUBLIC'; // Substitua pela sua chave anon public
